...
fun Route.ticketsRoutes(ticketsClient: ITicketsClient) {
        route("/api/ticket-types") {
                ...
                post("/release") {
                        ...
                        call.respond(
                                HttpStatusCode.OK,
                                mapOf("message" to "Tickets released successfully")
                        )
                }
                ...
                put("/{id}") {
                        ...
                        val ticketType = ticketsClient.updateTicketType(partnerId, id, request)
                        call.respond(ticketType)
                }
                ...
                delete("/{id}") {
                        ...
                        ticketsClient.deactivateTicketType(partnerId, id)
                        call.respond(
                                HttpStatusCode.OK,
                ...
                // POST /api/ticket-types/{id}/activate - Ativar tipo de ingresso
                post("/{id}/activate") {
                        val partnerId =
                                call.request.headers["X-Partner-Id"]
                                        ?: return@post call.respond(
                        ...
                        val ticketType = ticketsClient.activateTicketType(partnerId, id)
                        call.respond(ticketType)
                }
        }
}
