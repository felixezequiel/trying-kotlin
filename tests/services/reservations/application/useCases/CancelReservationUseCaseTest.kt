...
class CancelReservationUseCaseTest {
    ...
    fun setUp() {
        ...
        cancelReservationUseCase = CancelReservationUseCase(reservationRepository, ticketsClient)
    }
    ...
    fun `deve cancelar reserva com sucesso`() = runTest {
        ...
        val item = TestHelpers.createTestReservationItem(ticketTypeId = ticketTypeId, quantity = 2)
        val reservation =
    ...
    fun `deve cancelar reserva por partner`() = runTest {
        ...
        val reservation =
                TestHelpers.createTestReservation(customerId = customerId, eventId = eventId)
        reservationRepository.save(reservation)
