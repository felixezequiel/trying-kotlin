...
dependencies {
    ...
    // Ktor Client (para comunicação com outros serviços)
...
application {
    mainClass.set("reservations.infrastructure.web.MainKt")
}
...
sourceSets {
    ...
    test {
        kotlin.srcDirs("../../tests/services/reservations")
    }
}
